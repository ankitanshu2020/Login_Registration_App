...
<title>Login And Registration Page With Validation</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Full Stack Developer</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To My Java Full Stack Page</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Java Development - Web Development - JAVA</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">I am highly motivated and passionate Software Engineer with a strong academic background
 					and a passion for problem-solving and coding. Eager to contribute to dynamic projects,
 					applying theoretical knowledge to real-world applications.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">I am a quick learner with excellent teamwork and communication skills.
 					You can download my resume by clicking download button given below. I will highly appreciate if you send your sweet mail about my work.</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Hebbal, Bangalore (Karnataka) <br /> Pin Code : 577556
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/"><i
						...
						class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/ankitanshu9006/"><i
						class="fab fa-fw fa-linkedin-in"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://github.com/ankitanshu2020"><i
						class="fab fa-fw fa-github"></i></a>
				</div>
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Me</h4>
					<p class="lead mb-0">My full name is Ankitanshu Kumar, I am a 2023 passout B. Tech CSE student from 
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Please Support My Work</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
