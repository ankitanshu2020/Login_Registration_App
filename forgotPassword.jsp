			...
			<div class="col-lg-8 col-md-10">
				<div class="forgot">
					...
					<ol class="list-unstyled">
						...
						1. </span>Enter your email address below.</li>
						<li><span class="text-primary text-medium">
						2. </span>Our system will send you an OTP to your email</li>
						<li><span class="text-primary text-medium">
						3. </span>Enter the OTP on the next page</li>
					</ol>
				</div>
				<form class="card mt-4" action="forgotPassword" method="POST">
					<div class="card-body">
						<div class="form-group">
							...
							Enter the registered email address . Then we'll email a OTP to this address.</small>
						</div>
					</div>
